...
start_and_dimension_1 = StartAndDimension.StartAndDimension(coordinate_1, dimension_1)

color_1 = Color.RBGColor(255, 0, 0)

character_1 = Character.Character(start_and_dimension_1, color_1, background_color, vel, win)
